namespace MLib.Internal.Models
{
    ...
    {
        private readonly Dictionary<string, IThemeInfo> _Dic = new Dictionary<string, IThemeInfo>();
        ...
        {
            _Dic.TryGetValue(name, out IThemeInfo ret);
        ...
        {
            if (_Dic.TryGetValue(name, out IThemeInfo ret) == true)
            {
                _Dic.Remove(name);
                return ret;
            }
