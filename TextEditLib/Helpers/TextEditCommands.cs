...
namespace TextEditLib.Helpers
{
    ...
    public static class TextEditCommands
    {
        ...
        /// </summary>
        public static readonly RoutedCommand FoldsCollapseAll = new("CollapseAllFolds", typeof(TextEdit)
        ...
        /// </summary>
        public static readonly RoutedCommand FoldsExpandAll = new("CollapseAllFolds", typeof(TextEdit)
          ////, new InputGestureCollection { new KeyGesture(Key.D, ModifierKeys.Control) }
          );
    }
}
