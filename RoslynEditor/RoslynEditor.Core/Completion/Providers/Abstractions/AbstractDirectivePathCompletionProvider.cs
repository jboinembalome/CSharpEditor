...
namespace RoslynEditor.Core.Completion.Providers
{
    internal abstract class AbstractDirectivePathCompletionProvider : CompletionProvider
    {
        ...
        protected static FileSystemCompletionHelper GetFileSystemCompletionHelper(Document document,
            Microsoft.CodeAnalysis.Glyph itemGlyph, ImmutableArray<string> extensions, CompletionItemRules completionRules)
        {
            ...
            return new FileSystemCompletionHelper(Microsoft.CodeAnalysis.Glyph.OpenFolder, itemGlyph, searchPaths,
                GetBaseDirectory(document, serviceOpt), extensions, completionRules);
        }
        ...
        private static bool EndsWithQuote(string quotedPath) =>
            quotedPath.Length >= 2 && quotedPath[^1] == '"';
