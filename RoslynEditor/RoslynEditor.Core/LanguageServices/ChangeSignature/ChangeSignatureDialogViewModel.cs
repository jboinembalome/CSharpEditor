...
namespace RoslynEditor.Core.LanguageServices.ChangeSignature
{
    internal class ChangeSignatureDialogViewModel : NotificationObject
    {
        ...
        private readonly HashSet<IParameterSymbol> _disabledParameters = new();
        ...
        private static readonly SymbolDisplayFormat _symbolDeclarationDisplayFormat = new(
        ...
        private static readonly SymbolDisplayFormat _parameterDisplayFormat = new(
            genericsOptions: SymbolDisplayGenericsOptions.IncludeTypeParameters,
            miscellaneousOptions: SymbolDisplayMiscellaneousOptions.EscapeKeywordIdentifiers | SymbolDisplayMiscellaneousOptions.UseSpecialTypes,
            parameterOptions:
