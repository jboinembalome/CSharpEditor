...
namespace RoslynEditor.Core
{
    public class RoslynHost : IRoslynHost
    {
        ...
        public Func<string, DocumentationProvider> DocumentationProviderFactory =>
            _documentationProviderService.GetDocumentationProvider;
        ...
        protected virtual IEnumerable<Assembly> GetDefaultCompositionAssemblies() => DefaultCompositionAssemblies;

        protected virtual ParseOptions CreateDefaultParseOptions() => new CSharpParseOptions(kind: SourceCodeKind.Script,
        ...
        //internal static void AddMetadataReference(ProjectId projectId, AssemblyIdentity assemblyIdentity)
        //{
        //    // TODO
        //}
        ...
        {
            if (args == null)
                throw new ArgumentNullException(nameof(args).ToString());
            if (args.SourceTextContainer == null)
                throw new ArgumentNullException(nameof(args.SourceTextContainer).ToString());
        ...
        protected virtual Project CreateProject(Solution solution, DocumentCreationArgs args,
