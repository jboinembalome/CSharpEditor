...
namespace RoslynEditor.Windows
{
    public class MarkerMargin : AbstractMargin
    {
        ...
        public static readonly DependencyProperty LineNumberProperty = DependencyProperty.Register(
            nameof(LineNumber), typeof(int?), typeof(MarkerMargin),
        ...
        public MarkerMargin() => Marker = CreateMarker();
        #endregion
        ...
        private void TextViewVisualLinesChanged(object? sender, EventArgs e) => InvalidateArrange();
