...
namespace RoslynEditor.Windows
{
    public class DarkModeHighlightColors : IClassificationHighlightColors
    {
        ...
        public HighlightingColor DefaultBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(220, 220, 220)) };

        public HighlightingColor TypeBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(78, 201, 176)) };

        public HighlightingColor InterfaceBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(184, 215, 163)) };

        public HighlightingColor MethodBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(216, 216, 163)) };

        public HighlightingColor CommentBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(87, 166, 74)) };

        public HighlightingColor XmlCommentBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(200, 200, 200)) };

        public HighlightingColor XmlCdataBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(233, 213, 133)) };

        public HighlightingColor XmlCommentCommentBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(96, 139, 78)) };

        public HighlightingColor KeywordBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(86, 156, 214)) };

        public HighlightingColor ControlKeywordBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(220, 220, 220)) };

        public HighlightingColor PreprocessorKeywordBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(155, 155, 155)) };

        public HighlightingColor StringBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(214, 157, 133)) };

        public HighlightingColor StringEscapeBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(255, 214, 143)) };

        public HighlightingColor BraceMatchingBrush { get; protected set; } = 
            new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(220, 220, 220)), 
                Background = new SimpleHighlightingBrush(Color.FromRgb(14, 69, 131)) };

        public HighlightingColor StaticSymbolBrush { get; protected set; } = 
            new HighlightingColor { FontWeight = FontWeights.Bold };
        #endregion
        ...
        protected virtual ImmutableDictionary<string, HighlightingColor> GetOrCreateMap() => _map.Value;

        public HighlightingColor GetBrush(string classificationTypeName)
        {
            _ = GetOrCreateMap().TryGetValue(classificationTypeName, out var brush);
